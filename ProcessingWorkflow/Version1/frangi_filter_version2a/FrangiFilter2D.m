...
defaultoptions = struct('FrangiScaleRange', [10 20], 'FrangiScaleRatio', 2, 'FrangiBetaOne', 0.5, 'FrangiBetaTwo', 15, 'verbose',true,'BlackWhite',false);
% defaultoptions = struct('FrangiScaleRange', [1 3], 'FrangiScaleRatio', 1, 'FrangiBetaOne', 1, 'FrangiBetaTwo', 10, 'verbose',false,'BlackWhite',false);

% this: defaultoptions = struct('FrangiScaleRange', [1 2], 'FrangiScaleRatio', 1, 'FrangiBetaOne', 1, 'FrangiBetaTwo', 15, 'verbose',false,'BlackWhite',false);


% defaultoptions = struct('FrangiScaleRange', [1 1], 'FrangiScaleRatio', 1, 'FrangiBetaOne', 1, 'FrangiBetaTwo', 15, 'verbose',false,'BlackWhite',false);

% defaultoptions = struct('FrangiScaleRange', [1 2], 'FrangiScaleRatio', 1, 'FrangiBetaOne', 1, 'FrangiBetaTwo', 15, 'verbose',false,'BlackWhite',false);
